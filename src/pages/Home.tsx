  ...
  const features = [
    {
      ...
      description:
        "Access thousands of real interview experiences from top companies worldwide.",
    },
    {
      icon: <MessageSquare className="w-6 h-6" />,
      title: "Q&A Forum",
      description:
        "Get your questions answered by industry professionals and experienced peers.",
    },
    {
      icon: <Download className="w-6 h-6" />,
      title: "Resource Hub",
      description:
        "Download templates, guides, and tools to ace your next interview.",
    },
    {
      icon: <Award className="w-6 h-6" />,
      title: "Rewards System",
      description:
        "Earn points and badges for sharing knowledge and helping others.",
    },
  ];
  ...
  const steps = [
    {
      number: "01",
      title: "Sign Up",
      description: "Create your free account and join our community",
    },
    {
      number: "02",
      title: "Explore",
      description: "Browse experiences, ask questions, and download resources",
    },
    {
      number: "03",
      title: "Share",
      description: "Contribute your own experiences and help others succeed",
    },
    {
      number: "04",
      title: "Grow",
      description: "Build your network and advance your career",
    },
  ];
  ...
  const testimonials = [
    {
      ...
      content:
        "XShare helped me prepare for my dream job. The real interview experiences were invaluable!",
      rating: 5,
    },
    {
      ...
      content:
        "The community support and detailed experiences made all the difference in my job search.",
      rating: 5,
    },
    {
      name: "Emily Johnson",
      ...
      content:
        "From campus to career - XShare was my guide throughout the entire journey.",
      rating: 5,
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 leading-relaxed">
              Connect with professionals, share interview experiences, and
              accelerate your career growth through authentic knowledge sharing.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              help you transition from campus to your dream career.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="relative group bg-white p-8 rounded-2xl shadow-lg border border-transparent hover:border-orange-500 hover:shadow-2xl transition-all duration-300"
                initial={{ opacity: 0, y: 30 }}
                animate={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              ...
              >
                ...
                {/* Rating */}
                <div className="flex items-center mb-4 justify-center relative z-10">
                ...
                {/* Content */}
                <p className="text-gray-600 mb-6 leading-relaxed italic text-center relative z-10">
                  "{testimonial.content}"
                </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
              Join thousands of professionals who are sharing knowledge and
